  ...
  module Relay
    ...
    class Mutation
      ...
      accepts_definitions(
        ...
        return_type: GraphQL::Define::AssignMutationReturnType,
      ...
      # @api private
      attr_accessor :return_type_mode
      ...
      def initialize
        @fields = {}
        @arguments = {}
        @return_type_mode = :premade
      end

      def has_generated_return_type?
        # Trigger the generation of the return type, if it is dynamically generated:
        return_type
        @return_type_mode == :legacy
      end

      def resolve=(new_resolve_proc)
        @resolve_proc ||= begin
          return_type # ensure_defined
          wrap_result = @return_type_mode != :premade
          MutationResolve.new(self, new_resolve_proc, wrap_result: wrap_result)
        end
      end
      ...
      class Result
        ...
        def self.define_subclass(mutation_defn)
          subclass = Class.new(self) do
            return_field_names = mutation_defn.return_type.all_fields.map(&:name)
            attr_accessor(*return_field_names)
